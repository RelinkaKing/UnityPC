...
public class PublicClass
{
    ...
    public static SignElement LastSignElement;
    public static SignElement ThisSignElement;
    ...
    public static asset_platform platform { get { return Platform; } set { Platform = value; Debug.Log(Platform + "---------------------------------------------"); } }
    private static asset_platform Platform;
    // public static GameObject Model_A;
    public static bool is_rotate_screen; //是否旋转屏幕
    public static SplitMode splitmode;
    public static App app;
    public static ShowSignModel showSignModel;
    public static DataIntState DataManagerStatus;
